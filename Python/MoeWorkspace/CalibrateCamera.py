...
#np.save("./camera_params/retL", retL)
#np.save("./camera_params/kL", mtxL)
#np.save("./camera_params/distL", distL)
#np.save("./camera_params/rvecsL", rvecsL)
#np.save("./camera_params/tvecsL", tvecsL)
...
#np.save("./camera_params/retR", retR)
#np.save("./camera_params/kR", mtxR)
#np.save("./camera_params/distR", distR)
#np.save("./camera_params/rvecsR", rvecsR)
#np.save("./camera_params/tvecsR", tvecsR)
