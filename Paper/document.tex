...
Alternatively we can compute the corresponding distance to every disparity value with the inverse of this value. The relation between depth and disparity is non-linear, but by using the inverse this relation becomes linear. The equation for this is the following: 
\begin{equation}
	Distance = \frac{M}{Disparity}
\end{equation}
With M being the product of the focal length f and the baseline B of our camera. \newline
